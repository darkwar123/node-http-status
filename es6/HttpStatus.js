...
const TYPES = {"1xx": "Informational", "2xx": "Success", "3xx": "Redirection", "4xx": "Client Error", "5xx": "Server Error"};

const getStatusType = Symbol('getStatusType');
...
class HttpStatus extends Error{
    constructor(error){
        ...
        this.type = String(this[getStatusType]());
    }
    [getStatusType](){
        let template = Math.floor(this.status/100) + 'xx';
